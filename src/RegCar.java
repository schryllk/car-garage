...
public class RegCar extends Vehicle {
    ...
    public RegCar(int year, Make make, String model, BodyType bodyType, String color, FuelType fuelType, int price,
    ...
    public int getMaxDistance(int fuelEfficiency) {
        int fuelLevel = 99;
        this.maxD = fuelLevel * fuelEfficiency;
        return maxD;
    }
